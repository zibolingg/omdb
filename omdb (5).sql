...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2021 at 09:52 AM
...
(9, 'Bernard Hermann', 'Bernard', 'A', 'Hermann', 'male11', 'image file name');
...
(1, 1, 9, 'Composer'),
(18, 5, 5, 'music_director'),
(19, 5, 6, 'music_director'),
(20, 5, 7, 'music_director'),
(21, 5, 8, 'music_director'),
(22, 5, 9, 'music_director');
...
--
ALTER TABLE `movies`
  MODIFY `movie_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2002;

--
-- AUTO_INCREMENT for table `movie_people`
--
ALTER TABLE `movie_people`
  MODIFY `movie_people_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `songs`
  MODIFY `song_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `song_people`
--
ALTER TABLE `song_people`
  MODIFY `song_people_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
COMMIT;
