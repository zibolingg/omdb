...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2021 at 01:41 PM
...
(1, 'testing', 'testing', 'testing', 'jadoon', 'male', 'image file name'),
(2, 'testing', 'testing', 'testing', 'jadoon', 'male', 'image file name');
...
--
ALTER TABLE `people`
  MODIFY `people_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `songs`
--
ALTER TABLE `songs`
  MODIFY `song_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
