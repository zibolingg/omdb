...
--
-- Host: localhost
-- Generation Time: Aug 15, 2021 at 02:44 AM
...
(2002, 'Naruto', 'Naruto', 1998),
(2003, 'ドラゴンボールZ', 'Dragon Ball Z', 1989),
(2004, 'Mr. & Mrs. Smith', 'Mr. & Mrs. Smith', 2005),
(2005, 'Fight Club', 'Fight Club', 1999),
(2006, 'Bleach', 'Bleach', 1998),
(2007, 'Frozen', 'Frozen', 2013),
(2013, 'Finding Nemo', 'Finding Nemo', 2003),
(2018, '﻿Cars', 'Cars', 2006),
(2019, 'Toy Story', 'Toy Story', 1995),
(2020, 'Tangled', 'Tangled', 2010),
(2021, 'Lorax', 'Lorax', 2012);
...
CREATE TABLE `movie_anagrams` (
  `movie_id` int(11) NOT NULL COMMENT 'movie_anagrams is a WEAK entity. movie_id is both PK and FK',
...
CREATE TABLE `movie_numbers` (
  `movie_id` int(11) NOT NULL COMMENT 'This is both PK and FK; movie_numbers is a WEAK entity',
  `running_time` int(11) DEFAULT NULL COMMENT 'Running Time in Minutes',
  `length` int(11) DEFAULT NULL COMMENT 'length (depends on the native_name)',
  `strength` int(11) DEFAULT NULL COMMENT 'strengh (depends on the native_name)',
  `weight` int(11) DEFAULT NULL COMMENT 'weight (depends on native name)',
  `budget` int(11) DEFAULT NULL COMMENT 'budget in local (native) currency',
  `box_office` int(11) DEFAULT NULL COMMENT 'box office numbers in local (native) currency'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `movie_people` (
  `movie_people_id` int(11) NOT NULL,
  `movie_id` int(6) NOT NULL,
...
(41, 2002, 10, 'lead_actor'),
(42, 4, 5, 'lead_actor'),
(43, 4, 6, 'lead_actress'),
(44, 4, 7, 'supporting_actor'),
(45, 4, 10, 'supporting_actor'),
(46, 8, 8, 'lead_actress'),
(47, 10, 7, 'producer'),
(48, 10, 8, 'supporting_actor'),
(52, 9, 9, 'producer'),
(53, 9, 9, 'director'),
(54, 2003, 17, 'lead_actor'),
(55, 2004, 18, 'lead_actor'),
(56, 2004, 19, 'lead_actress'),
(57, 2004, 20, 'supporting_actor'),
(58, 2004, 21, 'supporting_actor'),
(59, 2004, 22, 'supporting_actress'),
(60, 2004, 23, 'producer'),
(61, 2004, 24, 'producer'),
(62, 2004, 25, 'director'),
(63, 2004, 26, 'music_director'),
(64, 2005, 27, 'lead_actor'),
(65, 2007, 70, 'lead_actress'),
(66, 2007, 71, 'lead_actress'),
(67, 2013, 1004, 'lead_actor'),
(68, 2013, 1005, 'lead_actor'),
(69, 2013, 1006, 'lead_actress'),
(71, 2013, 1007, 'supporting_actor'),
(72, 2017, 5, 'lead_actor');
...
INSERT INTO `movie_song` (`id`, `movie_id`, `song_id`) VALUES
(89, 4, 5),
(90, 4, 8),
(91, 4, 34),
(92, 2002, 38),
...
(10, 'Naruto Uzumaki', 'Naruto', '', 'Uzumaki', 'male', ''),
...
(17, 'Goku', 'Goku', '', '', 'Male', ''),
(18, 'John Smith', 'Brad', '', 'Pitt', 'Male', 'Image file name'),
(19, 'Jane Smith', 'Angelina ', '', 'Jolie', 'Female', ''),
(20, 'Benjamin Danz', 'Adam', '', 'Brody', 'Male', ''),
(21, 'Eddie', 'Vice', '', 'Vaughn', 'Male', ''),
(22, 'Jasmine', 'Kerry', '', 'Washington', 'Female', ''),
(23, 'Lucus Foster', 'Lucus', '', 'Foster', 'Male', ''),
(24, 'Arnon Milchan', 'Arnon', '', 'Milchan', 'Male', ''),
(25, 'Doug Liman', 'Doug', '', 'Liman', 'Male', ''),
(26, 'John Powell', 'John ', '', 'Powell', 'Male', ''),
(27, 'Tyler Durden', 'Brad', '', 'Pitt', '', ''),
(43, 'Knuth Kennedime', '', '', '', '', ''),
(44, 'Scottard Scurry', '', '', '', '', ''),
(45, 'xyzzy', '', '', '', '', ''),
(46, 'Woodrow S. Tondala', '', '', '', '', ''),
(47, 'Vicarius Icarium', '', '', '', '', ''),
(48, 'Inkwell LaSagna', '', '', '', '', ''),
(49, 'Kyler Krushev Junior', '', '', '', '', ''),
(50, 'Ricky Rindan', '', '', '', '', ''),
(51, 'Gada', '', '', '', '', ''),
(52, 'Yahya', '', '', '', '', ''),
(53, 'Marwan', '', '', '', '', ''),
(70, 'Elsa', 'Elsa', '', '', 'Female', ''),
(71, 'Anna', 'Anna', '', '', 'Female', ''),
(100, 'Tom Anderson', 'Tom', '', 'Anderson', '', ''),
(999, 'Brad Pitt', 'Brad', 'Pitt', 'Pitt', 'M', ''),
(1000, 'Brad Pitt', 'Brad', 'Pitt', 'Pitt', 'M', ''),
(1001, 'testing', 'testing', '2001', '', '', 'image file name'),
(1002, 'testing', 'testing', '2011', '', '', 'image file name'),
(1004, '﻿Marlin', 'Albert', '', 'Brooks', 'Male', 'image file name'),
(1005, 'Nemo', 'Alexander', '', 'Gould ', 'Male', 'image file name'),
(1006, 'Dory', 'Ellen', '', 'DeGeneres', '', 'image file name'),
(1007, 'Crush', 'Andrew', '', 'Stanton', 'Male', 'image file name'),
(1010, 'పింగళి నాగేంద్రరావు', '', '', '', 'male', 'image file name'),
(1011, '﻿Lightning McQueen', 'Owen', '', 'Wilson', 'Male', 'image file name'),
(1012, 'Doc Hudosn', 'Paul', '', 'Newman', 'Male', 'image file name'),
(1013, 'Sally Carrera', 'Bonnie', '', 'Hunt', 'Female', 'image file name');
...
(5, 'testing2', 'testing2', 'testing2'),
(6, 'test', 'test', 'test'),
(7, 'testing3', 'testing3', 'testing3'),
(8, 'testing4', 'testing4', 'testing4'),
(25, 'Ghostly Notes', '', ''),
(26, 'Kraken Dance', '', ''),
(27, 'Merry Merry Boat', '', ''),
(33, 'Let it Go', '', ''),
...
(36, 'Maria', '', ''),
(37, 'Dance at the Gym', '', ''),
(38, 'Blue bird ', '飛翔たいたら ', 'sorrow '),
(39, 'We Were Angels', 'From high in the sky', 'happy '),
(40, 'Love Stinks', '', ''),
(41, 'Baby, Baby', '', ''),
(42, 'Mondo Bongo', '', ''),
(43, 'I Melt With You', '', ''),
...
(45, 'Used to Love Her', '', ''),
(46, 'Making Love out..', '', ''),
(47, 'Nothin\' But A Good…', '', ''),
(48, 'Express Yourself', '', ''),
(49, 'Lady Lady Lay', '', ''),
(50, 'Nobody Does It…', '', ''),
(51, 'Assassin\'s Tango', '', ''),
(52, 'You Are My Sunshine', '', ''),
(53, 'You Give Love…', '\"You give love a bad name\"', 'Love'),
(54, 'Let it go', 'Let it go', 'Sad'),
(55, 'Snow Man', 'Want to build', 'Happy'),
(57, 'Never back down', 'Trending on water', 'strength'),
(59, 'testing', 'testing', '2001'),
(60, 'testing', 'testing', '2011'),
(63, '﻿Wow', '', ''),
(64, 'Barracuda', '', ''),
(65, 'Nemo Egg', '', ''),
(66, 'First Day', '', ''),
...
(70, 'Lost', '', ''),
(71, 'Short Term', '', ''),
(77, 'పింగళి నాగేంద్రరావు', 'Hello', ''),
(78, '﻿Real', 'American', ''),
(79, 'Ride', 'I feel the wind ', ''),
(80, 'Run that race', 'Another day', ''),
(81, 'Sh-Boom', 'Alang, alang, alang ', ''),
(82, 'Glory Days', 'Back in high school ', ''),
(83, 'Route 66', 'Get your kicks on Route 66 ', '');
...
CREATE TABLE `song_people` (
  `song_people_id` int(11) NOT NULL,
  `song_id` int(6) NOT NULL,
  `people_id` int(6) NOT NULL,
...
INSERT INTO `song_people` (`song_people_id`, `song_id`, `people_id`, `role`) VALUES
(1, 1, 9, 'Composer'),
(18, 25, 5, 'music_director'),
(19, 25, 5, 'lyricist'),
(21, 25, 6, 'singer'),
(22, 26, 5, 'music_director'),
(27, 5, 7, 'music_director'),
(28, 5, 7, 'lyricist'),
(29, 5, 6, 'singer'),
(30, 34, 8, 'lyricist'),
(31, 34, 6, 'music_director'),
(32, 34, 9, 'singer'),
(33, 6, 10, 'singer'),
(34, 6, 8, 'music_director'),
(35, 54, 70, 'singer'),
(36, 55, 71, 'singer'),
(37, 26, 5, 'lyricist'),
(38, 36, 5, 'lyricist'),
...
ALTER TABLE `movie_people`
  ADD PRIMARY KEY (`movie_people_id`);
...
ALTER TABLE `song_people`
  ADD PRIMARY KEY (`song_people_id`);
...
--
ALTER TABLE `movies`
  MODIFY `movie_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2022;

--
-- AUTO_INCREMENT for table `movie_people`
--
ALTER TABLE `movie_people`
  MODIFY `movie_people_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT for table `movie_song`
--
ALTER TABLE `movie_song`
...
--
ALTER TABLE `people`
  MODIFY `people_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1014;

--
-- AUTO_INCREMENT for table `songs`
--
ALTER TABLE `songs`
  MODIFY `song_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT for table `song_people`
--
ALTER TABLE `song_people`
  MODIFY `song_people_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
COMMIT;
