...
$sql = "SELECT `title`, `role`, `screen_name`, `people_id` AS `id` FROM `songs` INNER JOIN `song_people` ON `song_people`.`song_id`= `songs`.`song_id`INNER JOIN `people` ON `people`.`id`= `song_people`.`people_id`";
